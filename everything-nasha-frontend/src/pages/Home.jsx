      ...
      <section className="min-h-[85vh] bg-gradient-to-r from-pink-50 via-pink-100/30 to-amber-50/20 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 flex items-center transition-colors duration-300 py-12">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center w-full">
          <div>
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold leading-tight text-gray-900 dark:text-white tracking-tight">
              Beauty.
              <br />
              Confidence.
              <br />
            ...
            <div className="mt-8 flex gap-4">
              <Link
                to="/bookings"
                className="bg-black hover:bg-gray-800 dark:bg-pink-600 dark:hover:bg-pink-700 text-white px-8 py-4 rounded-xl font-semibold shadow-md transition-all duration-300 hover:scale-[1.02]"
              >
                Book Appointment
              </Link>
              ...
              <Link
                to="/services"
                className="border border-black dark:border-gray-700 text-black dark:text-white hover:bg-black/5 dark:hover:bg-white/5 px-8 py-4 rounded-xl font-semibold transition-all duration-300 hover:scale-[1.02]"
              >
                Explore Services
              </Link>
            </div>
      ...
      <section className="py-24 px-6 bg-white dark:bg-slate-900 transition-colors duration-300">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-slate-800/50 rounded-2xl overflow-hidden shadow-md border border-gray-100 dark:border-slate-800 hover:shadow-xl transition-all duration-300 group hover:-translate-y-1">
              ...
              <div className="p-8">
                <h3 className="text-2xl font-bold mb-3 text-gray-900 dark:text-white">Tattoos</h3>
            ...
            <div className="bg-white dark:bg-slate-800/50 rounded-2xl overflow-hidden shadow-md border border-gray-100 dark:border-slate-800 hover:shadow-xl transition-all duration-300 group hover:-translate-y-1">
              ...
              <div className="p-8">
                <h3 className="text-2xl font-bold mb-3 text-gray-900 dark:text-white">Nail Fixing</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            <div className="bg-white dark:bg-slate-800/50 rounded-2xl overflow-hidden shadow-md border border-gray-100 dark:border-slate-800 hover:shadow-xl transition-all duration-300 group hover:-translate-y-1">
              ...
              <div className="p-8">
                <h3 className="text-2xl font-bold mb-3 text-gray-900 dark:text-white">Lash Extensions</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
