    ...
    return (
        <>
            <div className="min-h-[85vh] bg-white dark:bg-slate-900 transition-colors duration-300 py-16 px-4 flex flex-col justify-center items-center">
                <div className="w-full max-w-2xl bg-white dark:bg-slate-800/40 p-8 md:p-10 rounded-3xl border border-gray-100 dark:border-slate-800/80 shadow-xl">
                    ...
                    {isConfirming ? (
                        ...
                        <div>
                            ...
                            {message.text && (
                                <div className={`p-4 mb-6 rounded-xl text-sm font-semibold border transition-all duration-300 ${
                                    message.isError 
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`p-3.5 rounded-xl border text-sm font-semibold transition-all duration-200 text-center cursor-pointer flex flex-col items-center justify-center gap-1 ${
                                                        isSelected 
                                                        ? "border-black dark:border-pink-500 bg-black dark:bg-pink-600 text-white shadow-sm scale-[1.02]" 
